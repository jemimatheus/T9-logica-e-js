 // 1. Faça um algoritmo que imprima números inteiros de n a 1 (Ex.: O usuário digita o número 10.
...
// }
 ...
 // 2. Dados dois números calcule o MDC deles.

// 3. Faça um algoritmo que imprima apenas os números ímpares de 1 a 100;
...
// alert(`A soma dos multuplos de 3 e 5 é ${soma}`)
...
// Simples
// 6. Faça um programa que leia um array e informe o maior número.


// const listaNumero = [2,30,24,16,32,50,2.9,99];
// let maiorNumero = 0;
...
// itens o cliente está levando e olhar na tabela de preços. Você foi contratado para desenvolver o programa que monta esta tabela de preços,
